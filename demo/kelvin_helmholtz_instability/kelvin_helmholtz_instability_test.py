"""Tests for the Kelvin-Helmholtz instability simulation."""
...
from swirl_c.demo.kelvin_helmholtz_instability import kelvin_helmholtz_instability
...
class KHInstabilityTest(tf.test.TestCase):
  ...
  @unittest.skip(
      'Temporarily disabling this test as it will be fixed in a subsequent CL.'
  )
  def test_kelvin_helmholtz_instability(self):
    """Tests the Kelvin-Helmholtz instability problem."""

    # Construct simulation objects.
    simulation = kelvin_helmholtz_instability.KHInstability()
    cfg = simulation.cfg
    run_name = _PREFIX
